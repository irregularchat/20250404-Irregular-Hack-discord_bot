...
class TestEmailMonitorBot(unittest.TestCase):
    """Unit tests for EmailMonitorBot"""
    ...
    def test_check_emails_with_new_emails(self, mock_sleep):
        ...
        self.mock_summarize_email.side_effect = lambda email: {
            **email,
        ...
        self.assertEqual(
            self.mock_notifier_instance.send_email_notification.call_count, 2
        )
    ...
    def test_start_monitoring_exception_handling(self, mock_sleep):
        ...
        self.mock_handler_instance.get_new_emails.side_effect = (
            mock_get_emails_with_exception
        )

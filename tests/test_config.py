...
class TestConfig(unittest.TestCase):
    ...
    def test_config_loading(self, mock_getenv):
        ...
        self.assertEqual(config.WHITELISTED_EMAIL_ADDRESSES, ['test1@example.com', 'test2@example.com'])
    ...
    def test_whitelist_parsing(self, mock_getenv):
        ...
        for i, test_value in enumerate(test_cases):
            ...
            mock_getenv.side_effect = lambda key, default=None: test_value if key == 'whitelisted_email_addresses' else default
